...
export class SkioPlanPicker extends LitElement {
  ...
  static styles = [
    css`
      ...
      .group-container {
        ...
        border: var(--skio-group-border-width, 1.5px) solid var(--skio-group-border-color, #11131452);
                    ...
                    <div class="group-topline">
                      ...
                      <div class="group-title">
                        ${group.name !== 'Prepaid' && this.options?.subscription_title
                          ...
                          : group.name}
                        ${this.options?.show_discount_text && this.discountText(group.selected_selling_plan)}
                      </div>
                      ...
                      <div class="skio-price" aria-live="polite">
                        ...
                        (this.selectedVariant?.compare_at_price > this.selectedVariant.price ||
                          ...
                          ? html`<s aria-hidden="true"
                            ...
                            >`
                          : ''}
                        <span>${this.price(group.selected_selling_plan)}</span>
                      </div>
                    </div>
  ...
  updateExternalPrice() {
    document.querySelectorAll(this.options?.external_price_selector).forEach((el) => {
      this.selectedSellingPlan
        ? (el.innerHTML = this.price(this.selectedSellingPlan))
        : (el.innerHTML = this.money(this.selectedVariant.price, '${{money_without_trailing_zeros}}'));
    });
  }
