    ...
    class ProductInfo extends HTMLElement {
      ...
      handleUpdateProductInfo(productUrl) {
        return (html) => {
          ...
          if (html.querySelector(`#FlavorDrawer-${this.sectionId}`)) {
            const source = html.querySelector(`#FlavorDrawer-${this.sectionId}`);
            const destination = document.querySelector(`#FlavorDrawer-${this.dataset.section}`);
            if (source && destination) {
              destination.innerHTML = source.innerHTML;
              destination.dispatchEvent(new CustomEvent('sb-flavor-drawer:refreshed', { bubbles: true }));
            }
          }
      ...
      updateMedia(html, variantFeaturedMediaId) {
        ...
        this.querySelectorAll(`media-gallery`).forEach((gallery) =>
